...
from app.api_test.forms.caseSuite import AddCaseSuiteForm, EditCaseSuiteForm, FindCaseSuite, GetCaseSuiteForm, \
    DeleteCaseSuiteForm, RunCaseSuiteForm
from utils.util.fileUtil import STATIC_ADDRESS


class ApiCaseSuiteDownloadView(LoginRequiredView):
...
class ApiCaseSuiteUploadView(LoginRequiredView):
...
api_test.add_url_rule("/caseSuite/upload", view_func=ApiCaseSuiteUploadView.as_view("ApiCaseSuiteUploadView"))
api_test.add_url_rule("/caseSuite/template/download", view_func=ApiCaseSuiteDownloadView.as_view("ApiCaseSuiteDownloadView"))
