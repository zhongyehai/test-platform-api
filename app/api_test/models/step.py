...
class ApiQuoteCaseStep(BaseStep):
    """ 修改引用用例的步骤，引用用例过后，修改被引用用例的步骤 """
    __abstract__ = False

    __tablename__ = 'api_test_step_quote_case'
    ...
    case_id = db.Column(db.Integer, nullable=True, comment='发起引用的用例id')
    step_id = db.Column(db.Integer(), nullable=True, comment='对应被引用用例的步骤id')
