...
def is_testcase(data: dict):
    """ 检验数据是否为测试用例
    为测试用例的特征：1、数据源为字典，2、字典中有名为teststeps的key，3、teststeps字段为list
    ...
    """
    return isinstance(data, dict) and "teststeps" in data and isinstance(data["teststeps"], list)
